...
public class ChangeModel {
	...
	public void calculate_difference( String dacnf_file_name ) {
...
//		}
	...
	public void generate() {
		...
		if (changed_type_and_default())
		{
			new File( PATCH_GEN_DIR ).mkdir();
			// TODO: const file name must be retrieved from the real dacnf file
			gen_pre_patch_script( dacnf.get_const_file_name() );
		}

		if( need_specific_upgrader() )
		{
			generate_src_struct();
	...
	private boolean changed_scales() {
		// TODO Auto-generated method stub
		return false;
	}

	private boolean changed_len_var_array() {
		// TODO Auto-generated method stub
		return false;
	}

	private boolean need_specific_upgrader() {
		// TODO Auto-generated method stub
		return true;
	}
	...
	private boolean changed_type_and_default() {
		return true;
	}
